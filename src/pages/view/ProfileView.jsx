                ...
                <section className='div1 p-5'>
                  ...
                  <div className='mb-4'>
                    ...
                    <p className='small'>
                      ...
                      ad-hoc tasks as requested by the IT Manager. Had a
                      specific brief to ensure the websites build for customer’s
                      precisely matched their requirements.developers and
                      marketers.
                    </p>
                  </div>
                  ...
                  <div className='mb-4'>
                    ...
                    <p className='small'>
                      Rebuilt and enhanced existing ASP B2C site with ASP.NET
                      2.0 Framework and tools. Technology consists of ASP.NET
                      2.0 (C#), IIS, Microsoft SQL Server 2005, Stored
                      Procedures & PayPal Instant Payment Notification.
                    </p>
                  </div>
                </section>
